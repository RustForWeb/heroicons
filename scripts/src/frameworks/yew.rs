...
// TODO: This file was copied from https://github.com/RustForWeb/lucide and has not yet been modified for Heroicons.
...
impl Framework for Yew {
    ...
    fn lib_header(&self) -> Option<String> {
        Some(
            "\
            //! Yew port of [Heroicons](https://heroicons.com/).\n\
            //!\n\
            //! Heroicons is a set of free MIT-licensed high-quality SVG icons for UI development.\n\
            //!\n\
            //! See [the Rust Heroicons book](https://heroicons.rustforweb.org/yew.html) for more documenation.\n\
            \n\
    ...
    fn generate(&self, component_name: String, svg: String) -> Result<TokenStream, Box<dyn Error>> {
        ...
        let svg: TokenStream = svg
            .replacen(
                "<svg",
                "<svg ref={props.node_ref.clone()} class={classes!(\"heroicons\", props.class.clone())} ",
                1,
            )
